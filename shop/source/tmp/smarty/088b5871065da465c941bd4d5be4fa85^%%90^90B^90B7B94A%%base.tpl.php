...
" >
    <head>
        <?php $_from = $this->_tpl_vars['oxidBlock_pageHead']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['_block']):
?>
        ...
        <?php if ($this->_tpl_vars['sStyle']): ?>
            <style>
                body {
                    <?php echo $this->_tpl_vars['sStyle']; ?>
...
<?php if ($_GET['plain'] == '1'): ?> popup<?php endif; ?><?php if ($this->_tpl_vars['blIsCheckout']): ?> is-checkout<?php endif; ?><?php if ($this->_tpl_vars['oxcmp_user'] && $this->_tpl_vars['oxcmp_user']->oxuser__oxpassword->value): ?> is-logged-in<?php endif; ?>">
    ...
    <div class="<?php if ($this->_tpl_vars['blFullwidth']): ?>container-fluid<?php else: ?>container<?php endif; ?>">
        <div class="main-row">
            <?php $_from = $this->_tpl_vars['oxidBlock_pageBody']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['_block']):
?>
                <?php echo $this->_tpl_vars['_block']; ?>
...
unset($_smarty_tpl_vars);
 ?>
        <?php echo smarty_function_oxscript(array('include' => "js/script.min.js",'priority' => 1), $this);?>
    ...
    <?php $_from = $this->_tpl_vars['oxidBlock_pageScript']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['_block']):
?>
        <?php echo $this->_tpl_vars['_block']; ?>
