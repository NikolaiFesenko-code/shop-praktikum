...
>
            <?php $_from = $this->_tpl_vars['otherlang']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
" class="saveinnewlangtext" style="width: 100px;" onClick="Javascript:document.myedit.fnc.value='saveinnlang'" <?php echo $this->_tpl_vars['readonly']; ?>
...
>
 ...
 <?php echo $this->_tpl_vars['readonly_fields']; ?>
>
            <?php $_from = $this->_tpl_vars['posslang']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
