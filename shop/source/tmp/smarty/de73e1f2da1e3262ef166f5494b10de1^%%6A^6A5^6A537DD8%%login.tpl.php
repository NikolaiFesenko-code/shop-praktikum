<?php /* Smarty version 2.6.34, created on 2025-02-01 09:05:27
...
" size="49"><br>
            ...
            <select name="chlanguage" id="lng">
                <?php $_from = $this->_tpl_vars['aLanguages']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
" <?php if ($this->_tpl_vars['oLang']->selected): ?>SELECTED<?php endif; ?>><?php echo $this->_tpl_vars['oLang']->name; ?>
            ...
            <select name="profile" id="prf">
                <?php $_from = $this->_tpl_vars['profiles']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
