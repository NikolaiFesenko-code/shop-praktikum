...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'order_list.tpl', 1, false),array('modifier', 'oxformdate', 'order_list.tpl', 67, false),array('modifier', 'cat', 'order_list.tpl', 75, false),array('modifier', 'oxupper', 'order_list.tpl', 76, false),array('modifier', 'oxtruncate', 'order_list.tpl', 77, false),array('modifier', 'oxaddslashes', 'order_list.tpl', 158, false),array('function', 'oxmultilang', 'order_list.tpl', 14, false),)), $this); ?>
 ...
 ?>>
            ...
            <td valign="top" class="listfilter" height="20">
                ...
                <select name="addsearchfld" class="folderselect" >
                    ...
                    <?php $_from = $this->_tpl_vars['asearch']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['table'] => $this->_tpl_vars['desc']):
?>
                    <?php $this->assign('ident', ((is_array($_tmp='ORDER_SEARCH_FIELD_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['desc']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['desc']))); ?>
