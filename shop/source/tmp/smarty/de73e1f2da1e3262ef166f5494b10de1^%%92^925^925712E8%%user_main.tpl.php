<?php /* Smarty version 2.6.34, created on 2025-02-01 09:06:29
         compiled from user_main.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'user_main.tpl', 1, false),array('modifier', 'lower', 'user_main.tpl', 95, false),array('modifier', 'regex_replace', 'user_main.tpl', 202, false),array('function', 'oxmultilang', 'user_main.tpl', 45, false),array('function', 'oxinputhelp', 'user_main.tpl', 54, false),)), $this); ?>
...
>
                    <?php $_from = $this->_tpl_vars['rights']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
<?php endif; ?>
            ...
            <tr>
                ...
                <td class="edittext"><br>
                <input type="password" class="editinput" size="15" name="newPassword" value="" autocomplete="new-password" <?php echo $this->_tpl_vars['readonly']; ?>
>
            ...
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "include/user_main_ldap.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
