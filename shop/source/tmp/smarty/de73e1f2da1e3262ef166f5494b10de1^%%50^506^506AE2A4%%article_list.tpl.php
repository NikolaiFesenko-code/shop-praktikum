...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'article_list.tpl', 1, false),array('modifier', 'cat', 'article_list.tpl', 69, false),array('modifier', 'oxupper', 'article_list.tpl', 70, false),array('modifier', 'oxlower', 'article_list.tpl', 74, false),array('modifier', 'oxtruncate', 'article_list.tpl', 118, false),array('modifier', 'strip_tags', 'article_list.tpl', 119, false),array('modifier', 'oxaddslashes', 'article_list.tpl', 140, false),array('function', 'oxmultilang', 'article_list.tpl', 50, false),)), $this); ?>
...
">
                <?php $_from = $this->_tpl_vars['mnftree']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
">
                <?php $_from = $this->_tpl_vars['vndtree']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
" <?php if ($this->_tpl_vars['pvnd']->selected): ?>SELECTED<?php endif; ?>><?php echo $this->_tpl_vars['pvnd']->oxvendor__oxtitle->value; ?>
                ...
                <select name="pwrsearchfld" class="editinput" onChange="Javascript:document.search.lstrt.value=0;top.oxid.admin.setSorting( document.search, 'oxarticles', this.value, 'asc');document.forms.search.submit();">
                    <?php $_from = $this->_tpl_vars['pwrsearchfields']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['field'] => $this->_tpl_vars['desc']):
?>
                    <?php $this->assign('ident', ((is_array($_tmp='GENERAL_ARTICLE_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['desc']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['desc']))); ?>
...
" <?php if ($this->_tpl_vars['pwrsearchfld'] == ((is_array($_tmp=$this->_tpl_vars['desc'])) ? $this->_run_mod_handler('oxupper', true, $_tmp) : smarty_modifier_oxupper($_tmp))): ?>SELECTED<?php endif; ?>><?php echo smarty_function_oxmultilang(array('noerror' => true,'alternative' => $this->_tpl_vars['desc'],'ident' => $this->_tpl_vars['ident']), $this);?>
</option>
                    <?php endforeach; endif; unset($_from); ?>
                </select>
...
', 'asc');document.search.submit();" class="listheader"><?php $this->assign('ident', ((is_array($_tmp='GENERAL_ARTICLE_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['pwrsearchfld']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['pwrsearchfld']))); ?><?php $this->assign('ident', ((is_array($_tmp=$this->_tpl_vars['ident'])) ? $this->_run_mod_handler('oxupper', true, $_tmp) : smarty_modifier_oxupper($_tmp))); ?><?php echo smarty_function_oxmultilang(array('ident' => $this->_tpl_vars['ident']), $this);?>
</a></td>
...
<?php if ($this->_tpl_vars['listitem']->showActiveCheckInAdminPanel): ?> active<?php endif; ?>" height="15"><div class="listitemfloating">&nbsp</a></div></td>
        <td valign="top" class="<?php echo $this->_tpl_vars['listclass']; ?>
...
">
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "include/article_list_actions.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        </td>
