...
<?php $this->assign('stickyHeader', $this->_tpl_vars['oViewConf']->getViewThemeParam('stickyHeader')); ?>
...
<?php if ($_GET['plain'] == '1'): ?> popup<?php endif; ?><?php if ($this->_tpl_vars['blIsCheckout']): ?> is-checkout<?php endif; ?><?php if ($this->_tpl_vars['oxcmp_user'] && $this->_tpl_vars['oxcmp_user']->oxuser__oxpassword->value): ?> is-logged-in<?php endif; ?><?php if (! $this->_tpl_vars['stickyHeader']): ?> static-header<?php endif; ?>"<?php if ($this->_tpl_vars['sStyle']): ?> style="<?php echo $this->_tpl_vars['sStyle']; ?>
"<?php endif; ?>>
...
?>
        ...
        <?php $_from = $this->_tpl_vars['oxidBlock_pagePopup']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['_block']):
?>
            <?php echo $this->_tpl_vars['_block']; ?>
