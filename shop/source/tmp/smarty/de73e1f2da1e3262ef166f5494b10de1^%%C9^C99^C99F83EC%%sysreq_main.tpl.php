...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'sysreq_main.tpl', 1, false),array('modifier', 'cat', 'sysreq_main.tpl', 12, false),array('modifier', 'oxupper', 'sysreq_main.tpl', 12, false),array('modifier', 'count', 'sysreq_main.tpl', 48, false),array('modifier', 'escape', 'sysreq_main.tpl', 62, false),array('function', 'oxmultilang', 'sysreq_main.tpl', 10, false),)), $this); ?>
...
:</h3>
    <?php $_from = $this->_tpl_vars['aInfo']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
?>
    <li class='group'><?php echo smarty_function_oxmultilang(array('ident' => ((is_array($_tmp=((is_array($_tmp='SYSREQ_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['sGroupName']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['sGroupName'])))) ? $this->_run_mod_handler('oxupper', true, $_tmp) : smarty_modifier_oxupper($_tmp))), $this);?>
        ...
        <?php $_from = $this->_tpl_vars['aModules']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
:</h3>
        <?php $_from = $this->_tpl_vars['aCollations']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['sTable'] => $this->_tpl_vars['aColumns']):
?>
        <li class="coll"><?php echo $this->_tpl_vars['sTable']; ?>

            <?php $_from = $this->_tpl_vars['aColumns']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
:</h3>
        <table class="moduleBlockErrorsTable">
            ...
            <tbody>
                <?php $_from = $this->_tpl_vars['_tplBlockErr']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
