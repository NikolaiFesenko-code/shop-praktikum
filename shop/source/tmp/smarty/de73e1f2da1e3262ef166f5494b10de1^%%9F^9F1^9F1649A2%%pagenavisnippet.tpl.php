...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'pagenavisnippet.tpl', 7, false),array('modifier', 'default', 'pagenavisnippet.tpl', 22, false),array('function', 'oxmultilang', 'pagenavisnippet.tpl', 29, false),)), $this); ?>
...
?>
  ...
  <?php $_from = $this->_tpl_vars['where']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['sTable'] => $this->_tpl_vars['aField']):
?>
    <?php $_from = $this->_tpl_vars['aField']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
">
 ...
 / <?php echo $this->_tpl_vars['pagenavi']->pages; ?>
        ...
        <td class="pagenavigation" height="22" align="center" width="33%">
           <?php $_from = $this->_tpl_vars['pagenavi']->changePage; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
